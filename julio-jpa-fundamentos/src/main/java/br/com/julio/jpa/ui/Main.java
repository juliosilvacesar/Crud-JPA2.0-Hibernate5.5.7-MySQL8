package br.com.julio.jpa.ui;

import java.util.List;
import java.util.Scanner;

import br.com.julio.jpa.models.Pessoa;
import br.com.julio.jpa.services.impl.PessoaService;
import br.com.julio.jpa.services.interfaces.CrudService;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		while (opcao != 6) {
			...
			SCANNER.nextLine();//uma forma de consumir o \n para assim ser possivel utilizar as outras opções
			switch (opcao) {
			case 1:
				listarPessoas();
				break;
